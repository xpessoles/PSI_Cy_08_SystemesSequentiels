...
\begin{center}
\begin{tabular}{cc}
\includegraphics[height=4cm]{DisqueGray} &
...
\begin{minipage}[c]{.2\linewidth}
\begin{center}
\includegraphics[width=.95\textwidth]{DisqueIncremental}
\end{center}
\end{minipage}
...
\begin{minipage}[c]{.45\linewidth}
\begin{center}
\includegraphics[width=.8\textwidth]{DisqueAbsolu}
...
\begin{center}
\includegraphics[width=.6\textwidth]{fig_08}
\end{center}
