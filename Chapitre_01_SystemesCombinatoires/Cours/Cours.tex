...
\marginnote{\xpComp{SEQ}{01}\xpComp{SEQ}{02}}
%
...
%\def\xxfigures{
%\begin{center}
%\includegraphics[width=.35\textwidth]{digicode}
%
%\textit{Digicode}
%\end{center}
%
%\begin{center}
%\includegraphics[width=.4\textwidth]{transistor_ttl_nand}
%
%\textit{Transistor TTL (permettant de réaliser des opérations logiques) }
%\end{center}
%
%\begin{center}
%\includegraphics[width=.4\textwidth]{inductif}
%
%\textit{Détecteur inductif}
%\end{center}
%
%\begin{center}
%\includegraphics[width=.5\textwidth]{capteur_contact}
%
...
\begin{marginfigure}
\includegraphics[width=\linewidth]{DisqueGray} 
\caption{Disque codage Gray}
\end{marginfigure}

\begin{marginfigure}
\includegraphics[width=\linewidth]{CodeurGray} 
\caption{Disque codage Gray}
\end{marginfigure}
...
%\begin{tabular}{cc}
%
%\includegraphics[height=3.5cm]{CodeurGray} \\
%\textit{} & 
...
\begin{marginfigure}
\includegraphics[width=.95\textwidth]{CodeurIncremental}
\end{marginfigure}

\begin{marginfigure}
\includegraphics[width=.5\textwidth]{DisqueIncremental}
\end{marginfigure}
...
\begin{center}
\includegraphics[width=\textwidth]{ChronogrammeIncremental}
\end{center}
\end{minipage} \hfill
\begin{minipage}[c]{.45\linewidth}
\begin{center}
...
\begin{minipage}[c]{.45\linewidth}
\begin{center}
\includegraphics[width=.7\textwidth]{DisqueAbsolu}
...
%
%\begin{center}
%\includegraphics[width=.9\textwidth]{fig_06}
%\end{center}
...
\begin{marginfigure}
\includegraphics[width=\textwidth]{fig_07_2}
\end{marginfigure}
...
\begin{center}
\includegraphics[width=.9\textwidth]{fig_09}
\end{center}
...
\begin{center}
\includegraphics[width=.9\textwidth]{oui}
\end{center}
\end{exemple}
...
\begin{center}
\includegraphics[width=.9\textwidth]{NON}
\end{center}
...
\begin{center}
\includegraphics[width=.9\textwidth]{ET}
\end{center}
...
\begin{center}
\includegraphics[width=.9\textwidth]{OU}
\end{center}
\end{exemple}
...
\begin{methode}[Détermination de la somme canonique]
...
\begin{methode}[Détermination du produit canonique]
...
\begin{defi}[Cellule universelle]
...
\begin{center}
\includegraphics[width=.6\textwidth]{fig_17}
\end{center}
...
%\marginnote{
\begin{itemize}
\item Supports de cours de David Violeau, Lycée Saint-Louis, Paris.
\item Supports de cours de Florestan Mathurin, Lycée Bellevue, Toulouse.
\end{itemize}
%}
%
