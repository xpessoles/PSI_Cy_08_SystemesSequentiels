...
\subparagraph{}
\textit{Proposer un diagarmme d'état permettant de régir le fonctionnement du codeur expérimental. On pourra utiliser les états suivants : état initial, incrémenter, décrémenter, attente.}
\ifprof
\begin{corrige}
\end{corrige}\else\fi
