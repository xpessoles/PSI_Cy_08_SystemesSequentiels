...
%
\begin{exemple}[Commande tout ou rien d'un moteur]
...
\begin{exemple}[Commande tout ou rien (TOR) d’un moteur]
...
\begin{marginfigure} 
\includegraphics[width=\textwidth]{activite_affectation}
...
\begin{marginfigure}
\includegraphics[width=\textwidth]{GroupeInstruction}
...
%\marginnote{
\begin{itemize}
\item {Stéphane Genouël, \textit{Systèmes Séquentiels -- Fonction mémoire}, Cours de MPSI -- PCSI, Lycée Chateaubriand, Rennes, \url{http://stephane.genouel.free.fr/}.} 
\item {Patrick Beynet et Al., \textit{Sciences Industrielles pour l'Ingénieur, MPSI -- PCSI}, Éditions Ellipses.}
\item {Pierre Debout, \textit{Automatique -- Systèmes à événements discrets}, Cours de PCSI.}
\item {Thierry Schanen, \textit{Guide des automatismes 9.1}, Pos Industry, 2009.}
\item {Olivier Le Gallo, Systèmes à événements discrets, Lycée Clémenceau, Nantes, \url{http://olivier.legallo.pagesperso-orange.fr/documents/SED.pdf}.}
\end{itemize}
%}
